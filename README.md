...
* **Safe Evolution:** พัฒนา Schema ได้ปลอดภัยเมื่อความต้องการข้อมูลทางคลินิกเปลี่ยนแปลง
...
| :--- | :--- | :--- |
| **Oncology dep** | HN, Name, CTSCAN_Type, TumorSize | ติดตามขนาดและตำแหน่งเนื้องอก |
| **Cardiology dep** | HN, Age, BMI, ContrastUsed | ประเมินความเสี่ยงและสภาวะหัวใจ |
| **Orthopedics dep** | HN, Gender, BMI, CTSCAN_Type | วิเคราะห์ความหนาแน่นกระดูก |
| **Management team** | ทุกฟิลด์ (Full Access) | ควบคุมคุณภาพ ปริมาณรังสี และความปลอดภัย |
