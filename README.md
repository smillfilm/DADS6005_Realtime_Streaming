...
1. การดำเนินการใดๆ กับคอลัมน์ที่ **มีการกำหนดค่าเริ่มต้น (Default Value)** จะได้รับอนุญาตเสมอทั้งในโหมด Forward, Backward และ Full compatibility.
2. การเพิ่มหรือลบคอลัมน์ที่ **ไม่มีการกำหนดค่าเริ่มต้น** ต้องระมัดระวังการเกิดข้อผิดพลาด `422 Unprocessable Entity`
3. **Specific Rules:**
    * **Forward Only:** อนุญาตให้เพิ่มคอลัมน์ใหม่ที่มีค่าและไม่มีค่าเริ่มต้นได้ แต่ในการลบ เดิมจะต้องมีค่าเริ่มต้น
    * **Backward Only:** อนุญาตให้ลบคอลัมน์เดิมที่มีค่าและไม่มีค่าเริ่มต้นได้ แต่ในการเพิ่มจะต้องกำหนดค่าเริ่มต้น
    * **Full:** คอลัมน์ที่ถูกเพิ่ม หรือถูกลบออก**ทั้งหมด**จะต้องมีการกำหนดค่าเริ่มต้นไว้เสมอ
  > หมายเหตุ: ทั้ง 3 ประเภท ( Forward / Backward / Full ) ไม่สามารถแก้ไข Datatype ได้
4. หากมีการแก้ไขหลายคอลัมน์ในการอัปเดตครั้งเดียว การดำเนินการจะสำเร็จได้ก็ต่อเมื่อ **ทุกคอลัมน์** ที่เกี่ยวข้องปฏิบัติตามกฎการตั้งค่าเริ่มต้นอย่างเคร่งครัด
