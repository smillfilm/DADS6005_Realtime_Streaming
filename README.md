...
2. การเพิ่มหรือลบคอลัมน์ที่ **ไม่มีการกำหนดค่าเริ่มต้น** จะส่งผลให้เกิดข้อผิดพลาด `422 Unprocessable Entity`
3. **Specific Rules:**
...
4. การมี **ค่าเริ่มต้น (default value)** คือปัจจัยที่สำคัญที่สุดในการตัดสินความเข้ากันได้ (Compatibility) เมื่อใช้งานโหมด **FULL**
